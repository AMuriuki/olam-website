  ...
  $('#frm_setup').submit(function (e) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        location.href = 'http://127.0.0.1:5050/auth/set_password?username=' + data['username'] + "&companyname=" + data['companyname'] + "&companyid=" + data['companyid'] + "&domainname=" + data['domainname'] + "&email=" + data['useremail'] + "&phone_no=" + data['userphone'] + "&country_code=" + data['country_code'];
      }
    })
  })
})
...
// if (current_href.toLowerCase().indexOf("new/database") >= 0) {
